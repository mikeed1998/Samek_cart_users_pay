...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-07-2023 a las 03:31:39
...
(12, 'Contacto', NULL, NULL, NULL, 0, 1, 666, 6);
...
--
-- Estructura de tabla para la tabla `s_subcategorias`
--

CREATE TABLE `s_subcategorias` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `categoria` int(11) NOT NULL,
...
--
-- Indices de la tabla `s_subcategorias`
--
ALTER TABLE `s_subcategorias`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `s_subcategorias`
--
ALTER TABLE `s_subcategorias`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
