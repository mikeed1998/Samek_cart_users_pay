...
<div class="container-fluid position-relative">
                        ...
                        <div class="col-12 py-2 bg-white" style="border-radius: 32px;">
                            <div class="row">
                                <div class="coltext-center">
                                    ...
                                    <textarea name="mensaje" id="" cols="30" rows="6" class="form-control border-0 placemensaje" placeholder="Mensaje"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-8 mx-auto">
                                    <div class="row">
                                        <div class="col-4 text-start rounded-circle">
                                            <img src="img/icono01.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-4 text-start">
                                            <img src="img/icono02.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="col-4 text-start">
                                            <img src="img/icono03.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-12 mt-xxl-0 mt-xl-0 mt-lg-0 mt-md-0 mt-sm-4 mt-xs-4 mt-4">
                            <div class="row mt-xxl-3 mt-xl-3 mt-lg-3 mt-md-0 mt-sm-0 mt-xs-0 mt-0">
                                ...
                                <div class="col-9 mx-auto text-start fs-5 text-light" style="line-height: 2;">
                                    contacto@samek.com Av. Lapizlázuli 2074, 44560 Guadalajara, Jal.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid position-absolute py-5 top-0 bottom-0 start-0 cuadro">

                <a href="{{ route('config.contact') }}" class="btn bg-white"> Editar Información de contacto </a>   
