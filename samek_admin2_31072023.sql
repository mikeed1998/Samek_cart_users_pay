...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-08-2023 a las 00:54:02
...
(4, 'Soluciones Texto', NULL, NULL, NULL, 0, 1, 666, 3),
...
INSERT INTO `s_productos` (`id`, `categoria`, `subcategoria`, `nombre`, `precio`, `cantidad`, `descripcion`, `imagen`, `created_at`, `updated_at`) VALUES
(1, 6, 2, 'Producto 1', NULL, NULL, 'Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creación de las hojas \"Letraset\", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.', 'MLpwMCChp9YTYSyTZF9MfJ25KvN1PR.jpg', '2023-08-01 03:18:44', '2023-08-01 04:53:04');
